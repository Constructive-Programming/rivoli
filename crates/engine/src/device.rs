...
//! `DeviceTier`, `DeviceBuf`, `VmmBuf`) that everything above `crate::device::`
...
mod tier {
    ...
    impl VmmBuf {
        ...
        /// launch, plus the end-of-layer [`rivoli_backend::hip::device_sync`] fencing slot
    ...
    impl Drop for VmmBuf {
        ...
        fn drop(&mut self) {
            ...
            let _ = rivoli_backend::hip::device_sync();
