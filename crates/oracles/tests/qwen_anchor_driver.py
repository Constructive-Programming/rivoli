...
# `--compare` still runs without one), `qwen_anchor_compare` judges them, `qwen_anchor_capture`
# holds the hooks, `qwen_anchor_taps` the values no hook can see and `qwen_anchor_defects` the
# matrix. All five sit beside this file,
...
from qwen_anchor_compare import (  # noqa: F401
    EXPECT_FIRST_TOUCH,
    by_operator,
    compare,
    operator_of,
...
from qwen_anchor_provenance import (  # noqa: F401
    FORBIDDEN_PACKAGES,
    _metadata,
    _reference_paths,
    preflight_env,
