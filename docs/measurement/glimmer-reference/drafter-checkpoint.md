...
All three match the plan. The KV figure is exact rather than rounded — 20,480 B *is* 20.0 KiB —
and the ring likewise, which is worth saying because "~20 KiB" and "≈260 MiB" read like estimates.
