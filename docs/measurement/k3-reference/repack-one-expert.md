...
`model-00002-of-000096.safetensors`. Header is 818,696 bytes, so tensor data begins at byte
`818,704`; the offsets below are the header's own `data_offsets` plus that base.

Layer 1, expert 0 — `language_model.model.layers.1.block_sparse_moe.experts.0.*`:

| tensor | dtype | shape | bytes | absolute range | sha256 (first 16) |
|---|---|---|---|---|---|
| `w1.weight_packed` | U8 | 3072×1792 | 5,505,024 | 1268218960–1273723983 | `7ce56d721eea1dbc` |
| `w1.weight_scale` | U8 | 3072×112 | 344,064 | 1274067984–1274412047 | `2711ff31127e735b` |
| `w2.weight_packed` | U8 | 3584×1536 | 5,505,024 | 1274412048–1279917071 | `f4dbcdbb0f7d2d02` |
| `w2.weight_scale` | U8 | 3584×96 | 344,064 | 1279917072–1280261135 | `525101a1b9d83ade` |
| `w3.weight_packed` | U8 | 3072×1792 | 5,505,024 | 1280261136–1285766159 | `405f4a03860b03a3` |
| `w3.weight_scale` | U8 | 3072×112 | 344,064 | 1285766160–1286110223 | `7fdf3a03ac6cd1a2` |
...
`L01.f4` sha256 begins `56d288cfb03aba135e39f61c3abd61a5`. 17,551,360 = `VQ_ALIGN` 4096 + 17,547,264,
