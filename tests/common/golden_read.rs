...
pub use rivoli::golden::GoldenSet;
...
/// FNV-1a over the whole file. Not a cryptographic claim — it exists so a vendored fixture that
/// changed by one byte cannot pass as the one a doc describes, and adding a sha2 dependency to the
/// engine to hash a test fixture is the worse trade.
